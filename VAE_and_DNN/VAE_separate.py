...
class classifier(layers.Layer):
    ...
    def __init__(self,                      
        ...
        self.classifier_layer0 = layers.Dense(50,activation=tf.keras.activations.softmax)   #it was 10 before    
    ...
    def call(self, inputs):
        ...
        #layer0 = self.dropout_layer(layer0)
        #print "\n layer0", layer0
        #layer1 = self.classifier_layer1(layer0) 
        #layer1= self.dropout_layer(layer1,training=training)
        #layer2 = self.classifier_layer2(layer1)   
        #layer2= self.dropout_layer(layer2,training=training)
...
class RecoAndDKL_Loss(tf.keras.Model):
    """Combines the encoder and decoder into an end-to-end model and returns the losses."""
    ...
    def __init__(self,
               ...
               half_input=10,
               latent_dim=5,
               name='RecoAndDKL_Loss',
               **kwargs):
        super(RecoAndDKL_Loss, self).__init__(name=name, **kwargs)
        self.original_dim = original_dim
        self.encoder = Encoder(
               intermediate_dim=intermediate_dim,
               input_dim=input_dim,
